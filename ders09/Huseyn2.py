...
Bir rəqəmə bir dəfə basmaq həmin düymədəki ilk hərfi yaradır.Rəqəmə 2, 3, 4 və ya 5 dəfə
basmaqla həmin düymədə olan ikinci, üçüncü, dördüncü və ya beşinci simvol daxil edilir.
...
Cədvəldə göstərilməyən simvolları (məsələn, nöqtəli vergül və mötərizələr) nəzərə almayın.
"""
...
my_word = input("Mesaj daxil edin.").upper()
for letter in my_word:
    for key, value in my_dict.items():
        if letter in value:
           my_message += str(key) * (value.index(letter)+1)
    my_message += " "
print(my_message)